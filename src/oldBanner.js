...
//   center.classList.remove('notification-center-hidden')
//   center.getElementsByTagName('a')[0].classList.remove('notification-center-anchor-hidden')
//   const flyout = document.getElementById('notification-center').children[1]
//   flyout.classList.remove('notification-center-flyout-hidden')
//   const container = flyout.getElementsByClassName('prompt-container')[0]
//   const notification = document.createElement('li')
//   notification.className = 'notification-item notification-center-message-with-prompts notification-center-message-warning'
//   notification.innerHTML = '<span class="notification-icon"></span><div class="notification-item-message vertical-align"><span>You have been inactive.  Your session will be logged out shortly for security reasons.Would you like to logout now?</span></div><div class="notification-item-prompts"><button class="notification-flyout-item" aria-labelledby="screen-reader-label-27">No</button><button class="notification-flyout-item">Yes</button></div>'
